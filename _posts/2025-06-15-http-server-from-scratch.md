...
- [What are Sockets and How Deep Can We Go When We Say "From Scratch"?](#what-are-sockets-and-how-deep-can-we-go-when-we-say-from-scratch)
  - [The Foundation: Operating System Socket APIs](#the-foundation-operating-system-socket-apis)
  - [What Exactly Is a Socket?](#what-exactly-is-a-socket)
  - [The Cup-and-String Analogy](#the-cup-and-string-analogy)
  - [How Sockets Work in Practice](#how-sockets-work-in-practice)
  - [Reality Check](#reality-check)
  - [Key Socket Concepts](#key-socket-concepts)
- [Building a Simple HTTP Server](#building-a-simple-http-server)
  - [Code Overview](#code-overview)
  - [Code Breakdown](#code-breakdown)
  - [Highlights](#highlights)
- [Using Telnet to Test the Server](#using-telnet-to-test-the-server)
  - [Installation](#installation)
  - [Connecting to the Server](#connecting-to-the-server)
  - [Making a Request](#making-a-request)
  - [Comparing with Browser](#comparing-with-browser)
- [Understanding the Structure of HTTP Request-Response](#understanding-the-structure-of-http-request-response)
  - [The Nature of HTTP](#the-nature-of-http)
  - [HTTP Headers](#http-headers)
  - [HTTP Message Anatomy](#http-message-anatomy)
- [Parsing client request](#parsing-client-request)
  - [Building an HTTP Request Parser](#building-an-http-request-parser)
  - [Understanding the RequestParser Code](#understanding-the-requestparser-code)
- [Handling endpoints and responses](#handling-endpoints-and-responses)
- [Building a Static Content Provider module](#building-a-static-content-provider-module)
  - [Understanding Content Types](#understanding-content-types)
  - [Building the StaticContentProvider Class](#building-the-staticcontentprovider-class)
  - [Initializing the Static Content Provider](#initializing-the-static-content-provider)
  - [Integrating Static Content into the Server](#integrating-static-content-into-the-server)
  - [Setting Up the Static Folder](#setting-up-the-static-folder)
  - [Testing Static Content](#testing-static-content)
  - [Why This Matters](#why-this-matters)
- [Building a Response Builder](#building-a-response-builder)
  - [Response Builder Code](#response-builder-code)
  - [Code Breakdown](#code-breakdown-1)
- [Defining HTTP Status Codes](#defining-http-status-codes)
  - [Explanation](#explanation)
- [Managing User Data](#managing-user-data)
  - [User Controller Code](#user-controller-code)
  - [Explanation](#explanation-1)
- [Mapping Endpoints to Controllers](#mapping-endpoints-to-controllers)
  - [Controller Map Code](#controller-map-code)
  - [Explanation](#explanation-2)
- [Initializing the Server Components](#initializing-the-server-components)
  - [Startup Code](#startup-code)
  - [Explanation](#explanation-3)
- [Putting It All Together](#putting-it-all-together)
  - [Updated Server Code](#updated-server-code)
  - [Code Breakdown](#code-breakdown-2)
  - [Testing the Server](#testing-the-server)
  - [Server Running Output](#server-running-output)
- [What's Next?](#whats-next)
  - [Ideas to Extend the Project](#ideas-to-extend-the-project)
